...
/** \addtogroup log
 @{
    ...
    выводятся все сообщения из первого уровня, а также сообщения, регламентируемые существующей
    нормативной базой.
...
/*! \param function Функция, которая используется для вывода сообщения.
    ...
    \note Функция содержит внутреннее ограничение на длину выводимой троки символов.
